...
;; https://openmobilitydata.org/p/helsinki-regional-transport/735

;; https://kaygun.tumblr.com/post/706432989785194496/graph-algorithms-in-clojure-with-jgrapht

;; https://jgrapht.org/javadoc-1.3.1/org/jgrapht/alg/scoring/BetweennessCentrality.html

(defonce stops
  (-> "data/hsl/stops.csv.gz"
      (tc/dataset {:key-fn keyword})))

(defonce stop-times
  (-> "data/hsl/stop_times.csv.gz"
      (tc/dataset {:key-fn keyword})))
